...
MusketFish::MusketFish(float aSize, int aDamage, int aSpeed) : Enemy(aSize, aDamage, aSpeed)
{
	size = aSize;
	damage = aDamage;
	speed = aSpeed;
	...
	pointsGained = 10;
	direction = 0;
	texture.loadFromFile("assets/MusketFish.png");
	enemy.setTexture(texture);
	enemy.setTextureRect(sf::IntRect(0, 0, 25, 23));

}

void MusketFish::setPosition(sf::Vector2f aPos)
{
